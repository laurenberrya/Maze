 ...
 *
 * Responsibility: Displays that the user has lost, along with directions on how to restart,
 * overall energy consumption, the length of the path taken and the length of the shortest
 * possible path.
 *
 * Collaborators: activity_losing.xml is the layout for this screen, and strings used on the layout
