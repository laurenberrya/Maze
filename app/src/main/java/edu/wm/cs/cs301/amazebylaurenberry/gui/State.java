...
public interface State {
	 ...
	 * 
	 * @param controller is a reference to the current controller, not used here
    ...
    /**
     * Sets the energy consumption of the robot
     * through the maze, typically of interest for 
     * the final screen.
     * @param energyConsumption tracked through the maze
     */
